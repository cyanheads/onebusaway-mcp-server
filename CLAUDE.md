...
src/
  ...
  config/
    server-config.ts                    # ONEBUSAWAY_API_KEY, ONEBUSAWAY_BASE_URL, ONEBUSAWAY_RATE_LIMIT_* (Zod schema)
  services/
    onebusaway/
